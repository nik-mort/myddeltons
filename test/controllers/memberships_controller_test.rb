...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { member_id: @membership.member_id, organisation_id: @membership.organisation_id, year: @membership.year } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { member_id: @membership.member_id, organisation_id: @membership.organisation_id, year: @membership.year } }
