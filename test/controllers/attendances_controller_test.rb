...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { events_id: @attendance.events_id, member_id: @attendance.member_id } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { events_id: @attendance.events_id, member_id: @attendance.member_id } }
